...
local function generate_limited_lives(lives_limit)
	...
	global.special_games_variables["limited_lives"]["lives_limit"] = lives_limit
	global.special_games_variables["limited_lives"]["player_lives"] = {}
	global.special_games_variables["limited_lives"]["has_life"] = function (player_name)
