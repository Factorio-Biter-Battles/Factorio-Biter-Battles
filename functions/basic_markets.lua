...
local function get_resource_market_sells()
	local sells = {
		{price = {{"coin", math.random2(5,10)}}, offer = {type = 'give-item', item = 'wood', count = 50}},
		{price = {{"coin", math.random2(5,10)}}, offer = {type = 'give-item', item = 'iron-ore', count = 50}},
		{price = {{"coin", math.random2(5,10)}}, offer = {type = 'give-item', item = 'copper-ore', count = 50}},
		{price = {{"coin", math.random2(5,10)}}, offer = {type = 'give-item', item = 'stone', count = 50}},
		{price = {{"coin", math.random2(5,10)}}, offer = {type = 'give-item', item = 'coal', count = 50}},
		{price = {{"coin", math.random2(8,16)}}, offer = {type = 'give-item', item = 'uranium-ore', count = 50}},	
		{price = {{"coin", math.random2(2,4)}}, offer = {type = 'give-item', item = 'crude-oil-barrel', count = 1}},				
	}
...
local function get_resource_market_buys()
	local buys = {
		{price = {{'wood', math.random2(10,12)}}, offer = {type = 'give-item', item = "coin"}},
		{price = {{'iron-ore', math.random2(10,12)}}, offer = {type = 'give-item', item = "coin"}},
		{price = {{'copper-ore', math.random2(10,12)}}, offer = {type = 'give-item', item = "coin"}},
		{price = {{'stone', math.random2(10,12)}}, offer = {type = 'give-item', item = "coin"}},
		{price = {{'coal', math.random2(10,12)}}, offer = {type = 'give-item', item = "coin"}},
		{price = {{'uranium-ore', math.random2(8,10)}}, offer = {type = 'give-item', item = "coin"}},
		{price = {{'water-barrel', 1}}, offer = {type = 'give-item', item = "coin", count = math.random2(1,2)}},
		{price = {{'lubricant-barrel', 1}}, offer = {type = 'give-item', item = "coin", count = math.random2(3,6)}},
		{price = {{'sulfuric-acid-barrel', 1}}, offer = {type = 'give-item', item = "coin", count = math.random2(4,8)}},
		{price = {{'light-oil-barrel', 1}}, offer = {type = 'give-item', item = "coin", count = math.random2(2,4)}},
		{price = {{'heavy-oil-barrel', 1}}, offer = {type = 'give-item', item = "coin", count = math.random2(2,4)}},
		{price = {{'petroleum-gas-barrel', 1}}, offer = {type = 'give-item', item = "coin", count = math.random2(3,5)}},
	}
	...
	for _, market_type in pairs(market_types) do
		for k, item in pairs(market[market_type]) do
			...
			if item.rarity <= rarity then
				local price = math.random2(math.floor(item.value * 0.75), math.floor(item.value * 1.25))
...
function Public.mountain_market(surface, position, rarity)
	...
	for i = 1, math.random2(5, 10), 1 do
		local item = items[i]
...
function Public.super_market(surface, position, rarity)
	...
	for i = 1, math.random2(6, 12), 1 do
