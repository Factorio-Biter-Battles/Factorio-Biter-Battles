...
function Public.playground_surface()
	...
	local int_max = 2 ^ 31
	map_gen_settings.seed = math_random(1, int_max)
	...
	map_gen_settings.autoplace_controls = {
		...
		["trees"] = {frequency = math_random(8, 28) * 0.1, size = math_random(6, 14) * 0.1, richness = math_random(2, 4) * 0.1},
...
function Public.tables()
	...
	if math_random(1,2) == 1 then global.next_attack = "south" end
end
