...
function Public.initial_setup()
    ...
    game.map_settings.path_finder.max_clients_to_accept_any_new_request = 8 -- default 10
    ...
    --Enables event profiler and logging
    storage.event_profiler_enabled = false
    --Disable Nauvis
