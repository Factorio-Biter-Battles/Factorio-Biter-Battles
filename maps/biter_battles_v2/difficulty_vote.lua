...
local difficulties = {
	...
	[1] = {name = "I'm Too Young to Die", str = "50%", value = 0.5, color = {r=0.00, g=0.45, b=0.00}, print_color = {r=0.00, g=0.9, b=0.00}},
	[2] = {name = "Piece of Cake", str = "75%", value = .75, color = {r=0.00, g=0.35, b=0.00}, print_color = {r=0.00, g=0.7, b=0.00}},
