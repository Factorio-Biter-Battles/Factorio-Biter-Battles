...
local difficulties = {
	...
	[1] = {name = "Sleepy", str = "30%", value = 0.3, color = {r=0.00, g=0.45, b=0.00}, print_color = {r=0.00, g=0.9, b=0.00}},
	...
	[7] = {name = "Nightmare", str = "150%", value = 1.5, color = {r=0.35, g=0.00, b=0.00}, print_color = {r=0.7, g=0.0, b=0.00}},
	[8] = {name = "Insane", str = "175%", value = 1.75, color = {r=0.45, g=0.00, b=0.00}, print_color = {r=0.9, g=0.0, b=0.00}}
}
