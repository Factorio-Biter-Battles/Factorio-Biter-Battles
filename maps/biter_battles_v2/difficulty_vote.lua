...
local difficulties = {
	...
	[1] = {name = "Peaceful", str = "45%", value = 0.45, color = {r=0.00, g=0.45, b=0.00}, print_color = {r=0.00, g=0.9, b=0.00}},
	...
	[6] = {name = "Nightmare", str = "175%", value = 1.75, color = {r=0.35, g=0.00, b=0.00}, print_color = {r=0.7, g=0.0, b=0.00}},
	[7] = {name = "Insane", str = "250%", value = 2.5, color = {r=0.45, g=0.00, b=0.00}, print_color = {r=0.9, g=0.0, b=0.00}}
}
