...
local difficulties = {
	...
	[2] = {name = "Beginner", str = "60%", value = 0.6, color = {r=0.00, g=0.25, b=0.00}, print_color = {r=0.00, g=0.7, b=0.00}},
	...
	[6] = {name = "Absurd", str = "200%", value = 2, color = {r=0.35, g=0.00, b=0.00}, print_color = {r=0.7, g=0.0, b=0.00}}
}
