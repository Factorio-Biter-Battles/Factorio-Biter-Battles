...
local function add_changelog(player, element)
    ...
    add_entry('2024-07-17', 'RedRafe', 'Fix ping alert and map countdown sound bugs')
    add_entry('2024-07-17', 'Ragnarok77', 'Implement task system for captain game')
    ...
    add_entry('2024-07-03', 'cliff_build', 'Captain pick order rework')
    add_entry('2024-07-03', 'PlayerNoon', 'implement burners balance.')
    add_entry('2024-07-02', 'cliff_build', '/difficulty-revote no longer resets evo after teams have fed')
    add_entry('2024-07-01', 'cliff_build', 'Fix captains pick-UI when groups are disabled')
    add_entry('2024-06-23', 'Ragnarok77', 'Captain event : show amount of players before the players list')
    add_entry('2024-06-21', 'cliff_build', 'Main gui: make buttons much more responsive')
    ...
    add_entry('2024-05-21', 'cliff_build', 'Initial/experimental support for @ping in chat')
    add_entry('2024-05-20', 'penguinencounter', 'flib + Research overview screen rework (again)')
    add_entry('2024-05-20', 'cliff_build', 'Captains more improvements')
    add_entry('2024-05-18', 'cliff_build', 'captains game kick from team: use a dropdown rather than a textbox')
    add_entry(
        '2024-05-17',
        'penguinencounter',
        'Use Factorio button styles instead of font color on Captain UI elements for enhanced readability'
    )
    add_entry('2024-05-16', 'cliff_build', 'sciencelogs: fix a bug when looking at the UI before any sends')
    add_entry('2024-05-16', 'cliff_build', 'Captains games join UI rework')
    add_entry('2024-05-15', 'cliff_build', "support '/instant_map_reset current' to reset to current seed")
    add_entry('2024-05-15', 'cliff_build', 'Stop always broadcasting admin chat messages')
    ...
    add_entry('2024-04-21', 'gsquaredxc', 'Remove Game.get_player_by_index and Game.get_player_from_any')
    add_entry('2024-04-21', 'cliff_build', 'Speed up ai_targets random target selection')
    add_entry('2024-04-21', 'vadcx', 'Change color, fix and refactor Captain mode text')
    add_entry('2024-04-21', 'vadcx', 'Compress Captain Countdown images (3.1MB -> 860KB, 0.27x size) ')
    add_entry('2024-04-20', 'vadcx', 'Comment hardcoded values for _LIFECYCLE checks')
    add_entry('2024-04-20', 'cliff_build', 'Fix error printing to show real stacktraces')
    add_entry('2024-04-18', 'vadcx', 'profiler.lua: gracefully disable profiler in unsupported versions')
    ...
    add_entry('2024-04-04', 'LackOfTropicalFruit', 'Update killscore to be proportionate to threat')
    add_entry('2024-04-04', 'DrButtons', 'Delete player_modifiers.lua')
    add_entry('2024-04-04', 'DrButtons', 'Delete Unused files in functions folder')
    add_entry('2024-03-27', 'LackOfTropicalFruit', 'Updating default difficulty setting to Easy.')
    add_entry('2024-03-25', 'developer-8', 'Fix Event.add_removable_nth_tick_function')
    add_entry('2024-03-25', 'DrButtons', 'Small code cleanups, remove legacy/old commands')
    add_entry('2024-03-25', 'DrButtons', 'move on_player_mined_entity to control-dispatch')
    add_entry('2024-03-22', 'DrButtons', 'Sync safe group-name with captain group picking')
    add_entry('2024-03-22', 'cliff_build', 'Add a new tab displaying mutagen values and resource costs')
    add_entry('2024-03-16', 'cliff_build', 'Small improvements to /calc-send')
    add_entry('2024-03-16', 'cliff_build', 'Grant infinite-fish-vision when using send-all')
    add_entry('2024-03-15', 'cliff_build', 'Fix chat messages not showing up in Discord')
    add_entry('2024-03-15', 'cliff_build', 'Game start time: set it to 0 when something actually happens')
    add_entry('2024-03-15', 'DrButtons', 'Refactor get_formatted_playtime')
    add_entry('2024-03-14', 'DrButtons', 'Remove legacy debug code')
    add_entry('2024-03-14', 'cliff_build', "Avoid 'LuaTile API call when LuaTile was invalid.' error")
    add_entry('2024-03-14', 'cliff_build', 'Automatically clear_cusor when spectating')
    add_entry('2024-03-13', 'DrButtons', 'fix boss_unit death tracking')
    add_entry('2024-03-13', 'cliff_build', 'revamp evo/threat calculation, and add /calc-send command')
    add_entry('2024-03-13', 'DrButtons', 'fix group names that overlap with luaguielement')
    add_entry('2024-03-13', 'cogito123', 'Allow tag manipulation when frozen')
    add_entry('2024-03-12', 'cliff_build', 'Refactor/standardize most code that prints out team names')
    add_entry('2024-03-09', 'Ragnarok77', 'Fix playtime rank')
    add_entry('2024-03-09', 'cogito123', 'Rework of biter terrain texture to be factorio 2.0 compatible')
    add_entry('2024-03-09', 'bits-orio', 'Increase the size and edit ratio of mixed patches ')
    ...
    add_entry('2021-12-25', 'uneuro', 'holidays')
    ...
    add_entry('2021-05-23', 'uneuro', "Revert 'few commands for WE. no need revert after event end. (i think so :D )'")
    ...
    add_entry('2021-05-09', 'uneuro', 'More improvements 1')
    add_entry('2021-05-09', 'Hornwitser', 'Revert #140')
    add_entry('2021-05-09', 'uneuro', 'Laser and mutagen suggestions')
    add_entry('2021-05-01', 'derkachdaniil', 'Update feeding.lua - buff endgame biters')
    add_entry('2021-04-26', 'uneuro', 'Balance update 1')
    ...
    add_entry('2020-12-20', 'uneuro', 'put back normal values for nades')
    ...
    add_entry('2020-12-15', 'uneuro', 'add mysticamber link for discord bot')
    ...
    add_entry('2020-12-10', 'uneuro', 'default bbv2')
    add_entry('2020-12-10', 'uneuro', 'Update control.lua')
