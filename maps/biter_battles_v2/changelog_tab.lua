...
local function add_changelog(player, element)
	...
	add_entry("2024-08-13", "ness056", "Add event priority")
	add_entry("2024-08-11", "cliff_build", "Fix /replaceCaptainNorth command")
	add_entry("2024-08-10", "developer-8", "Fix reply notification to wrong player")
	add_entry("2024-08-07", "PlayerNoon", "You can turn off flashlight in config")
	add_entry("2024-08-07", "RedRafe", "Feedbacks & fixes")
	add_entry("2024-08-06", "PlayerNoon", "add message for discord server chat when match starts")
	add_entry("2024-08-06", "RedRafe", "UI updates")
	...
	add_entry("2024-05-24", "cliff_build", "Add storage.threat_multiplier")
	...
	add_entry("2024-05-17", "penguinencounter", "Use Factorio button styles instead of font color on Captain UI elements for enhanced readability")
