...
local function get_stored_position(player)
    local p = nil
...
local function get_spawn_position(player)
    local surface = player.surface
    return surface.find_non_colliding_position('character', player.force.get_spawn_position(surface), 16, 0.5)
end
