...
Public.food_values = {
	["automation-science-pack"] =		{value = 0.00065, name = "automation science", color = "255, 50, 50"},
	["logistic-science-pack"] =		{value = 0.0018, name = "logistic science", color = "50, 255, 50"},
	["military-science-pack"] =		{value = 0.0100, name = "military science", color = "105, 105, 105"},
	["chemical-science-pack"] = 		{value = 0.0275, name = "chemical science", color = "100, 200, 255"},
	["production-science-pack"] =		{value = 0.1250, name = "production science", color = "150, 25, 255"},
	["utility-science-pack"] =		{value = 0.2500, name = "utility science", color = "210, 210, 60"},
