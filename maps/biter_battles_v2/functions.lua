...
function Functions.create_map_intro_button(player)
	local b = Gui.add_top_element(player, {type = "sprite-button", sprite = "utility/custom_tag_icon", name = "map_intro_button", tooltip = "[font=default-bold]Scenario Info[/font] - Read the introduction to Biter Battles" })
end
