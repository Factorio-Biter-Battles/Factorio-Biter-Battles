...
local balance_functions = {
	["flamethrower"] = function(force_name)
		global.combat_balance[force_name].flamethrower_damage = -0.75
	...
	["stronger-explosives"] = function(force_name)
		global.combat_balance[force_name].grenade_damage = global.combat_balance[force_name].grenade_damage + 0.1					
