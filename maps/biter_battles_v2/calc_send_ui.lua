...
-- side of the food search bounding square
local FOOD_SEARCH_DISTANCE_SPAN = 2 * 32
...
local function on_fill_from_remote_view_clicked(button)
    ...
    local search_bbox = {
        left_top = { x = pos.x - FOOD_SEARCH_DISTANCE_SPAN / 2, y = pos.y - FOOD_SEARCH_DISTANCE_SPAN / 2 },
        right_bottom = { x = pos.x + FOOD_SEARCH_DISTANCE_SPAN / 2, y = pos.y + FOOD_SEARCH_DISTANCE_SPAN / 2 },
    }
