...
function test_feed_values()
    local config = {
        -- AUTOMATION
        {
            ...
            chance = { '0.02', '0.04', '0.06', '0.07' },
        },
        {
            amount = 5000,
            name = 'automation-science-pack',
            chance = { '0.17', '0.27', '0.34', '0.39' },
        },
        {
            amount = 10000,
            name = 'automation-science-pack',
            chance = { '0.27', '0.39', '0.46', '0.52' },
        },
        {
            amount = 100000,
            name = 'automation-science-pack',
            chance = { '0.71', '0.85', '0.94', '1.00' },
        },
        --- LOGISTICS
        {
            amount = 200,
            name = 'logistic-science-pack',
            chance = { '0.03', '0.05', '0.07', '0.09' },
        },
        {
            amount = 5000,
            name = 'logistic-science-pack',
            chance = { '0.31', '0.43', '0.51', '0.57' },
        },
        {
            amount = 10000,
            name = 'logistic-science-pack',
            chance = { '0.43', '0.57', '0.65', '0.71' },
        },
        --- MILITARY
        {
            amount = 200,
            name = 'military-science-pack',
            chance = { '0.09', '0.16', '0.20', '0.24' },
        },
        {
            amount = 5000,
            name = 'military-science-pack',
            chance = { '0.57', '0.72', '0.80', '0.86' },
        },
        {
            amount = 10000,
            name = 'military-science-pack',
            chance = { '0.72', '0.86', '0.95', '1.00' },
        },
        --- CHEMICAL
        {
            amount = 200,
            name = 'chemical-science-pack',
            chance = { '0.19', '0.29', '0.35', '0.41' },
        },
        {
            amount = 5000,
            name = 'chemical-science-pack',
            chance = { '0.77', '0.92', '1.00', '1.00' },
        },
        {
            amount = 10000,
            name = 'chemical-science-pack',
            chance = { '0.92', '1.00', '1.00', '1.00' },
        },
        --- PRODUCTION
        {
            amount = 200,
            name = 'production-science-pack',
            chance = { '0.42', '0.55', '0.63', '0.69' },
        },
        {
            amount = 1000,
            name = 'production-science-pack',
            chance = { '0.74', '0.88', '0.97', '1.00' },
        },
        {
            amount = 5000,
            name = 'production-science-pack',
        ...
        --- UTILITY
        {
            ...
            chance = { '0.51', '0.64', '0.73', '0.79' },
        },
        {
            amount = 1000,
            name = 'utility-science-pack',
            chance = { '0.84', '0.99', '1.00', '1.00' },
        },
        --- SPACE
        {
            amount = 1000,
            name = 'space-science-pack',
            chance = { '0.99', '1.00', '1.00', '1.00' },
        },
        {
            amount = 2000,
            name = 'space-science-pack',
